...
public class ProjectsBuilderTest extends TestCase {
    ...
    public ProjectsBuilderTest(String testName) {
        super(testName);
    }
    ...
    public static Test suite() {
        return new TestSuite(ProjectsBuilderTest.class);
    }

    public void testProjectsBuilderList() {
        ProjectsBuilder projectsBuilder = new ProjectsBuilder.List().build();
        command.addCommand(projectsBuilder);
        String projectGuid = command.getResult(projectsBuilder).getProjectByName("Best-Practice 10.1.0.1").getGuid();
        assertEquals(properties.getProperty("cms.test.project.guid"), projectGuid);
    }
