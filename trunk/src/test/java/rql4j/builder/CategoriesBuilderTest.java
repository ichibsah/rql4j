...
public class CategoriesBuilderTest extends TestCase {

    private final static String CATEGORY_VALUE = "Test Category";
    ...
    public CategoriesBuilderTest(String name) {
        super(name);
    }

    public static Test suite() {
        return new TestSuite(CategoriesBuilderTest.class);
    }

    public void testCategoriesBuilderLoad() throws Exception {
        CategoriesBuilder categoriesBuilder = new CategoriesBuilder.List().build();
        Category category = command.getResult(categoriesBuilder).getCategoryByValue(CATEGORY_VALUE);
        Assert.assertEquals(this.categoryGuid, category.getGuid());
    }
