...
public class EltBuilderTest extends TestCase {
    ...
    public EltBuilderTest(String name) {
        super(name);
    }

    public static Test suite() {
        return new TestSuite(EltBuilderTest.class);
    }

    public void testEltBuilderSave() {
        EltBuilder eltBuilder = new EltBuilder.Save().Elt("6AB0E4EAC8054A39821E73225CC74523", "Gute Nacht").build();
        command.addCommand(eltBuilder);
        command.execute();
    }
