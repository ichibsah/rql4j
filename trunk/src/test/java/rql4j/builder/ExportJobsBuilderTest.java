...
public class ExportJobsBuilderTest extends TestCase {
    RqlCommand command;
    ...
    public ExportJobsBuilderTest(String name) {
        super(name);
    }

    public static Test suite() {
        return new TestSuite(ExportJobsBuilderTest.class);
    }

    public void testExportBuilderSave() throws Exception {
        ExportJobsBuilder exportJobsBuilder = new ExportJobsBuilder.List(properties.getProperty("cms.test.project.guid")).build();
        command.addCommand(exportJobsBuilder);
        command.execute();
    }
}
