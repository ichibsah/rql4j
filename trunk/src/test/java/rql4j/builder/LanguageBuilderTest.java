...
public class LanguageBuilderTest extends TestCase {
    ...
    public LanguageBuilderTest(String name) {
        super(name);
    }

    public static Test suite() {
        return new TestSuite(LanguageBuilderTest.class);
    }

    public void testLanguageBuilderList() throws Exception {
        LanguageBuilder languageBuilder = new LanguageBuilder.List().build();
        command.getResult(languageBuilder);
    }
}
