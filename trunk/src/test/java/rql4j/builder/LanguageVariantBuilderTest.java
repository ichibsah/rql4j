...
public class LanguageVariantBuilderTest extends TestCase {
    RqlCommand command;
    ...
    public static Test suite() {
        return new TestSuite(LanguageVariantBuilderTest.class);
    }

    public void testLanguageVariantBuilderSetActive() throws Exception {
        LanguageVariantBuilder builder = new LanguageVariantBuilder.SetActive(properties.getProperty("cms.test.languagevariant.guid")).build();
        command.addCommand(builder);
        command.execute();
    }
}