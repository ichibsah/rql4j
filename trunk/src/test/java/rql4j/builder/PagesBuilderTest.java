...
public class PagesBuilderTest extends TestCase {
    RqlCommand command;
    String loginGuid;
    ...
    public PagesBuilderTest(String name) {
        super(name);
    }

    public void testPagesBuilderLoad() {
        RqlBuilder loadBuilder = new PagesBuilder.List().build();
        command.getResult((PagesBuilder)loadBuilder);
    }
}
