...
public class ModulesBuilderTest extends TestCase {

    RqlCommand command;
    String loginGuid;
    Properties properties;

    public ModulesBuilderTest(String testName) {
        super(testName);
    }

    public static Test suite() {
        return new TestSuite(ModulesBuilderTest.class);
    }
    ...
    public void testModulesBuilderList() throws Exception {
        ModulesBuilder modulesBuilder = new ModulesBuilder.List().build();
        command.getResult(modulesBuilder);
    }
}
