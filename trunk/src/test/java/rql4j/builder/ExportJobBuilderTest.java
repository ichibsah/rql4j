...
public class ExportJobBuilderTest extends TestCase {
    RqlCommand command;
    ...
    public ExportJobBuilderTest(String name) {
        super(name);
    }

    public static Test suite() {
        return new TestSuite(ExportJobBuilderTest.class);
    }

    public void testExportBuilderSave() throws Exception {
        DateTime dt = new DateTime();
        Date pubDate = dt.toDate();
        ExportJobBuilder exportJobBuilder = new ExportJobBuilder.Save(properties.getProperty("cms.test.project.guid"),
                properties.getProperty("cms.test.page.guid"),true, true, properties.getProperty("cms.test.user.guid"))
                .startGenerationAt(pubDate)
                .LanguageVariant("CD6E24119EB0456F846FCA3DFA61EFA5", true)
                .ProjectVariant("46C79AFC3F0C4EBC8C124D7A13FF1FF0", true)
                .build();
        command.getResult(exportJobBuilder);
    }
}
