...
public class RqlCommand {
    ...
    public void execute() {
        ...
        while (!commands.isEmpty()) {
            ...
            if (command instanceof AdministrationBuilder &&
                    result.getLogin() != null &&
                    result.getLogin().getGuid() != null)
                worker.setLoginGuid(result.getLogin().getGuid());
            if (command instanceof AdministrationBuilder &&
                    result.getServer() != null &&
                    result.getServer().getKey() != null)
                worker.setSesionKey(result.getServer().getKey());
