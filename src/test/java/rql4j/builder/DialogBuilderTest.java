...
public class DialogBuilderTest extends TestCase {
    RqlCommand command;
    ...
    public DialogBuilderTest(String name) {
        super(name);
    }

    public static Test suite() {
        return new TestSuite(DialogBuilderTest.class);
    }

    public void testDialogBuilderListLanguages() throws Exception {
        DialogBuilder dialogBuilder = new DialogBuilder.ListLanguages().OrderBy(Dialog.OrderBy.COUNTRY_CODE).build();
        command.getResult(dialogBuilder);
    }
}
